# RAG4 本地项目概览（初始化前历史快照）

> **适用范围更正（2026-09-16）**：本文记录的是 2026-09-14 导入源码之前的工作区，不代表当前项目。当前已存在 Git 仓库和完整 `project/`，代码基准为 `4b0e1dd`，已完成模型基础设施与 Phase 1 结构化切分，最近完整后端测试为 156 passed。当前事实请阅读 [开发过程记录](project/docs/development_process.md)、[基线记录](RAG4_BASELINE.md) 和 [README](README.md)。以下内容保留为初始状态的历史依据。
